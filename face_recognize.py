...
# Written + Documented by Numan Ibn Mazid
...
# haar_file path
haar_file = '/home/numan/MEGA/AI_LEARN/Machine Learning Practical/haarcascades/haarcascade_frontalface_default.xml'
# path to the main faces directory which contains all the sub_datasets
datasets = '/home/numan/MEGA/AI_LEARN/Machine Learning Practical/my_images/'
...
while True:
	...
	# uses the same method as in the create_data.py file
        ...
        if prediction[1] < 74:
            cv2.putText(im,'%s, Welcome!' % (names[prediction[0]].strip()),(x + 5, (y + 25) + h), cv2.FONT_HERSHEY_PLAIN,1.5,(20,185,20), 2)
